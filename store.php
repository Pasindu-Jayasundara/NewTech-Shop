    ...
    <div class="container-fluid">
        <div class="row text-white bg-black">
            ...
            <div class="col-12">
                ...
                <p class="fs-3" style="color: chartreuse; cursor:pointer;" onclick="window.location='store2.php';">Laptop &nbsp;&nbsp;&rarr;</p>
                ...
                <div class="col-lg-12 col-12 d-lg-flex flex-lg-column  c ">
                    <div class="col-lg-12 col-sm-12 d-lg-flex flex-lg-row d-xl-flex flex-xl-row justify-content-lg-evenly d-flex flex-column align-items-center d-sm-flex flex-sm-row align-items-sm-start d">
                        ...
                        <div class="card text-center mb-3 mb-lg-0 col-sm-3 mx-lg-0 mx-xl-auto" style="width: 18rem; margin-right: 2%;">
                            ...
                            <div class="card-body  text-black fw-bold col-lg-12" style="background-color:rgb(213, 192, 235);">
                                ...
                                <a href="#" class="btn btn-outline-primary col-5 col-lg-5" onclick="window.location='singleProductView.php';">View</a>
                    ...
                    <p class="fs-3 mb-0" style="color: chartreuse; cursor:pointer;" onclick="window.location='store2.php';">Computers &nbsp;&nbsp;&rarr;</p>
                    ...
                    <p class="fs-3 mb-0" style="color: chartreuse; cursor:pointer;" onclick="window.location='store2.php';">Mobile Phones &nbsp;&nbsp;&rarr;</p>
                    ...
                    <p class="fs-3 mb-0" style="color: chartreuse; cursor:pointer;" onclick="window.location='store2.php';">Camera &nbsp;&nbsp;&rarr;</p>

    ...
    <div class="container-fluid">
        <div class="row bg-black text-white min-vh-100">
            ...
            <div class="d-flex flex-row p-0 card-text my-5 justify-content-center">
                <i class="bi bi-arrow-left-square position-absolute fs-3" style="margin-left: -95%; cursor: pointer;" onclick="history.back();"></i>
                ...
                <div class="border border-1 border-white rounded bg-dark col-6 d-flex justify-content-center mx-4">
                    ...
                    <div class="col-11 pt-4 px-3">
                        <form class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label for="validationDefaultUsername" class="form-label">Resigned Date & Time</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="validationDefaultUsername" aria-describedby="inputGroupPrepend2" value="2022-09-01" disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
